...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Entdecken Sie kontrollierte AI-Systeme für Sales, Service, Operations und Unternehmenswissen.",
  ...
  "@graph": [
    {
      ...
      description: "CONLYRA verbindet AI-Agenten, Workflow-Automatisierung, Voice AI, Private Intelligence, Integrationen und Governance zu kontrollierten Lösungen für reale Unternehmensprozesse.",
      inLanguage: "de-DE",
...
export default function SolutionsPage() {
  return (
    <>
      <main id="main"><SolutionsHubExperience /></main>
