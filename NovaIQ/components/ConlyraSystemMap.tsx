...
const products: Product[] = [
  ...
  },
  {
    ...
    description: "Operative Abläufe, Signale und Aktionen als kontrollierte, nachvollziehbare Systemflüsse.",
    question: "WIE LÄUFT ARBEIT?",
  ...
  },
  {
    ...
    description: "Unternehmenswissen als private, kontrollierte Kontextschicht für Menschen und Agenten.",
    question: "WELCHER KONTEXT?",
  ...
  },
  {
    ...
    question: "WIE INTERAGIERT DAS SYSTEM?",
  ...
  },
  {
    ...
    description: "Menschen, Daten, Prozesse und Governance bewerten, um die richtigen AI-Piloten zu priorisieren.",
    question: "WO SOLLTE AI STARTEN?",
  ...
  },
  {
    ...
    description: "CRM, ERP, Kommunikation und Datenquellen als kontrollierter Operating Stack verbinden.",
    question: "WOMIT ARBEITET DAS SYSTEM?",
  ...
  },
  {
    ...
    description: "Identitäten, Rechte, Freigaben, Risiken und Traceability für kontrollierte AI-Ausführung.",
    question: "WAS DARF DAS SYSTEM?",
...
export function ConlyraSystemMap() {
  ...
  const activePathIndex = useMemo(
    () => pathSequence.findIndex((code) => code === active.code),
    [active.code],
  );
  ...
  return (
    ...
    >
      ...
      <div className={styles.container}>
        <header className={styles.head} data-system-map-reveal>
          <div>
            ...
            <h2 id="conlyra-system-map-title">
              Sieben Product Worlds.
              <span>Ein Operating System.</span>
            </h2>
          </div>
          <aside>
        ...
        <div className={styles.systemShell} data-system-map-reveal>
          <div className={styles.mapPanel}>
            <div className={styles.mapTopbar}>
              <span>CONLYRA / GLOBAL SYSTEM GRAPH</span>
              <strong><i /> 07 / 07 ONLINE</strong>
            </div>
            ...
            <div className={styles.mapStage}>
              ...
              <div className={styles.activeSignal} key={active.code} aria-hidden="true">
            ...
            <div className={styles.mapFooter}>
              <span>GRAPH / INTERACTIVE</span>
              <span>ACTIVE / {active.code}</span>
          ...
          <aside className={styles.previewPanel}>
            <header>
              <span>ACTIVE PRODUCT WORLD</span>
              <strong>{active.code} / 07</strong>
            </header>
              ...
              <div>
                {pathSequence.map((code, index) => (
                  <button
                    key={code}
                    type="button"
                    data-active={activePathIndex === index}
                    onClick={() => setActiveIndex(products.findIndex((product) => product.code === code))}
                    aria-label={`Product ${code} auswählen`}
                  >
                    {code}
                  </button>
                ))}
            ...
            <Link href={active.href} className={styles.openProduct}>
          ...
          {pathSequence.map((code, index) => {
            ...
            return (
              <button
                type="button"
                key={product.code}
                data-active={active.code === product.code}
                onClick={() => setActiveIndex(products.findIndex((item) => item.code === product.code))}
              >
      ...
      <div className={styles.rail}>
        <span>CONLYRA SYSTEM MAP / COMPLETE</span>
        <span>07 PRODUCTS / 01 OPERATING SYSTEM</span>
      </div>
    </section>
  );
}
